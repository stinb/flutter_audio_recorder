    ...
    switch call.method {
      case "current":
        ...
        if audioRecorder == nil {
          ...
          let averagePowerForChannel: Float = audioRecorder.averagePower(forChannel: channel)
          let range: Float = 160.0
          let offset: Float = 32.0
          let SPL = 20.0 * log10(referenceLevel * powf(10.0, averagePowerForChannel / 20.0) * range) + offset
          ...
          recordingResult["averagePower"] = SPL
